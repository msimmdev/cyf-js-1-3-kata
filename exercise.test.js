...
test("Check function returns array", () => {
  expect(Array.isArray(exercise.filterNumberArray([], 1, 1))).toBe(true);
});

test("Check funcion returns numbers", () => {
  expect(exercise.filterNumberArray([1, 2, 3, 4, 5, 6, 7, 8, 9], 2, 7)).toEqual(
    [2, 3, 4, 5, 6, 7]
  );
});

test("Check function returns single number", () => {
  expect(exercise.filterNumberArray([1, 2, 3, 4, 5, 6, 7, 8, 9], 5, 5)).toEqual(
    [5]
  );
});
...
test("Check invalid input", () => {
  expect(
    exercise.filterNumberArray(
      [false, 1, 2, "three", 4, 5, 6, undefined, 8, 9],
      1,
      10
    )
...
test("Check invalid limits", () => {
  expect(exercise.filterNumberArray([1, 2, 3, 4, 5, 6, 7, 8, 9], 7, 2)).toEqual(
    [1, 2, 3, 4, 5, 6, 7, 8, 9]
  );
});
